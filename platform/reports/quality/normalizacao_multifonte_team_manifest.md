...
**Estado:** `BLOCKED_NOT_APPROVED` para cutover ativo; decisão pesquisada materializada em `shadow_team_identity_20260715` e no [TSV final](./team_identity_manifest_20260715.tsv)
...
Evidência: mesmo clube semântico, grafias/IDs de provedor distintos; o relatório de diagnóstico reproduz os seis pares Flamengo × América-MG nos dois lados. Nome fuzzy isolado não foi usado. Confiança final e aprovação permanecem pendentes.
