...
- Resumo JSON: `platform/reports/quality/external_coach_coupling_summary.json`
- Candidatos promoviveis: `platform/reports/quality/external_coach_coupling_promotable_candidates.csv`
- Conflitos: `platform/reports/quality/external_coach_coupling_conflicts.csv`
- Cobertura por recorte: `platform/reports/quality/external_coach_coupling_coverage.csv`
