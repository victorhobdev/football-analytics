...
|---|---:|
| `canonical_team` | **1.931** IDs internos ativos |
...
A segunda execução foi feita após a primeira e preservou a cardinalidade, o crosswalk e o rekey. O hash de conteúdo final do cadastro foi `bf5e2575e3f8d1219b2bb4832e510a12`; o do crosswalk foi `cec1aa70fc14aa0a63ebecbdced28a72`; o do manifesto foi `fc334fbfe110fed8b1993b7ec0d7f22a`.

O critério de 1.933 IDs não foi forçado: a auditoria mostrou que ele contava quatro entidades no componente Belenenses, embora os três legados representem clube + SAD. A materialização correta é 1.931; o delta está registrado no relatório semântico e no manifesto TSV.
